...
//Decelaration 
var n1: string | null = prompt("Enter 1st Number")!
var n2: string | null  = prompt("Enter 2nd Number")!
var n3: string | null = prompt("Enter 3rd Number")!

//typeCasting
var no1: number = parseInt(n1)
var no2: number = parseInt(n2)
var no3: number = parseInt(n3)
...
//Decelaration 
var n1: string | null = prompt("Enter the Number")!
...
var N1:string | null = prompt("Enter Year")!
...
var char: string | null= prompt("Enter the character")!
...
var letter: string | null = prompt("Enter the Alphabet Letter")!
